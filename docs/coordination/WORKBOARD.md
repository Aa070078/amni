...
| **M5-003 Sales/Inventory dashboard KPIs + E2E sales journey** | M5 | agent-m5-erp-sales-inv | in-progress | feat/M5/erp-sales-inv | revenue/AR/aging/low-stock KPIs from real ERP; Playwright signup→wizard→provision→customer→product→order→invoice→payment |
