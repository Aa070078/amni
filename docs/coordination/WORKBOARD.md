...
| **M10-003 Equity, ESG, and signing tenant persistence** | M10 | codex-market-launch | in-progress | feat/M10/noncore-domain-persistence | Add supported Amni Bridge DocTypes and ERP-backed APIs for non-core domains. |
