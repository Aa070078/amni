...
| **M10-005 Bounded ERP queries + tenant data-plane health** | M10 | codex-market-launch | in-progress | feat/M10/bounded-queries-tenant-health | Push filtering/pagination into ERPNext, replace the static global search index, and add background tenant health/degraded operator UX. |
