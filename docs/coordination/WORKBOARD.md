...
| **M10-004 Specialist roles and domain authorization** | M10 | codex-market-launch | in-progress | feat/M10/roles-settings-persistence | Persist specialist membership roles and remaining Settings/expense metadata; enforce domain authorization server-side and filter navigation/actions. |
