...
const docs: Record<string, unknown>[] = [
  ...
  domainRecord("expenses", "category", "CAT-TRAVEL0001", { code: "CAT-TRAVEL0001", name: "Travel", color: "blue", status: "active", createdAt: timestamp(-300), updatedAt: timestamp(-30) }, { title: "Travel", status: "active", search_text: "CAT-TRAVEL0001 Travel" }),
